...
const double earth_gravity_g = 9.81998; // m/s^2
...
int main(int argc, char** argv) {
    ...
    while (ros::ok()) {
        ...
        if (message.messageType == FREESPACE_MESSAGE_MOTIONENGINEOUTPUT) {
            struct MultiAxisSensor accel, accelNoGrav, actClass, angPos,
                                   angVel, compass, inclination, mag;
            ...
            if(have_accel && have_angVel && have_angPos) {
                ...
                // Are these units correct? I think so.
                ...
                // Are these units correct? Not sure.
                ...
                // Are these units correct? Not sure.
                msg.linear_acceleration.x = accel.x * earth_gravity_g;
                msg.linear_acceleration.y = accel.y * earth_gravity_g;
                msg.linear_acceleration.z = accel.z * earth_gravity_g;
